...
-- 04 - Clean and Transform Raw Data
-- Snowflake Version
-- ============================================================
...
-- ============================================================
-- 7. TRANSFORMED ORDER-SALES DATA
-- ============================================================

CREATE OR REPLACE TABLE STG_ORDER_SALES AS
SELECT
    o.order_id,
    s.sale_id,
    o.order_date,
...
-- ============================================================
-- 8. AGGREGATED ORDER COSTS
-- ============================================================

CREATE OR REPLACE TABLE STG_ORDER_COSTS AS
SELECT
    order_id,
...
CREATE OR REPLACE TABLE STG_FINAL_SALES AS
SELECT
    os.order_id,
    os.sale_id,
    os.order_date,
    ...
    os.sales_channel
FROM STG_ORDER_SALES os
LEFT JOIN STG_ORDER_COSTS oc
